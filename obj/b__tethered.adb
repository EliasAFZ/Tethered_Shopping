pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__tethered.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__tethered.adb");
...
package body ada_main is
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_tethered");
...
--  BEGIN Object file/option list
   --   D:\College\Fall 2018\itec-320 (ADA)\HW4\obj\tethered.o
   --   -LD:\College\Fall 2018\itec-320 (ADA)\HW4\obj\
   --   -LD:\College\Fall 2018\itec-320 (ADA)\HW4\obj\
   --   -LD:/ide/gps/lib/gcc/x86_64-pc-mingw32/7.3.1/adalib/
   --   -static
   --   -lgnat
   --   -Wl,--stack=0x2000000
